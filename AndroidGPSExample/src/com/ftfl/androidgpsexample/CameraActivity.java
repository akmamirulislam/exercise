...
public class CameraActivity extends Activity {
	...
	Button mButtonPhotoRegister = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mButtonPhotoRegister = (Button) findViewById(R.id.btnPhotoRegister);

		mButtonPhotoRegister.setOnClickListener(new View.OnClickListener() {
